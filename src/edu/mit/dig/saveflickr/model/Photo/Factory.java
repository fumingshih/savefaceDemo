 ...
 * <p>(URI: http://sharonmyrtle.com/DIG/flick/photo#)</p>
 * <br>
 * <br>
 * <br>
 */
public class Factory extends com.ibm.adtech.jastor.ThingFactory { 
	...
	public static Photo createPhoto(Resource resource, Model model) throws JastorException {
		return edu.mit.dig.saveflickr.model.Photo.PhotoImpl.createPhoto(resource,model);
	}
	...
	public static Photo createPhoto(String uri, Model model) throws JastorException {
		Photo obj = edu.mit.dig.saveflickr.model.Photo.PhotoImpl.createPhoto(model.createResource(uri), model);
		return obj;
	}
	...
	public static Photo getPhoto(Resource resource, Model model) throws JastorException {
		String code = (model.hashCode()*17 + edu.mit.dig.saveflickr.model.Photo.Photo.class.hashCode()) + resource.toString();
		edu.mit.dig.saveflickr.model.Photo.PhotoImpl obj = (edu.mit.dig.saveflickr.model.Photo.PhotoImpl)objects.get(code);
		if (obj == null) {
			obj = edu.mit.dig.saveflickr.model.Photo.PhotoImpl.getPhoto(resource, model);
			if (obj == null)
				return null;
	...
	/**
	 * Return an instance of Photo for every resource in the model with rdf:Type http://www.foolme.csail.mit.edu/ns/flickr/Photo.owl#Photo
	 * @param model the Jena Model
	...
	public static Thing getThing(com.hp.hpl.jena.rdf.model.Resource res, com.hp.hpl.jena.rdf.model.Model model) throws JastorException {
		if (res.hasProperty(RDF.type,model.getResource("http://www.foolme.csail.mit.edu/ns/flickr/Photo.owl#Photo"))) {
	...
	public static java.util.List listCompatibleInterfaces (com.hp.hpl.jena.rdf.model.Resource type) {
		...
		if (type.equals(edu.mit.dig.saveflickr.model.Photo.Photo.TYPE)) {
			types.add(edu.mit.dig.saveflickr.model.Photo.Photo.class);
		}
		return types;
	}
}