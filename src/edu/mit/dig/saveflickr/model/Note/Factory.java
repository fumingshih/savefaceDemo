 ...
 * <p>(URI: http://sharonmyrtle.com/DIG/flick/note#)</p>
 * <br>
 * <br>
 * <br>
 */
public class Factory extends com.ibm.adtech.jastor.ThingFactory { 
	...
	public static Note createNote(Resource resource, Model model) throws JastorException {
		return edu.mit.dig.saveflickr.model.Note.NoteImpl.createNote(resource,model);
	}
	...
	public static Note createNote(String uri, Model model) throws JastorException {
		Note obj = edu.mit.dig.saveflickr.model.Note.NoteImpl.createNote(model.createResource(uri), model);
		return obj;
	}
	...
	public static Note getNote(Resource resource, Model model) throws JastorException {
		String code = (model.hashCode()*17 + edu.mit.dig.saveflickr.model.Note.Note.class.hashCode()) + resource.toString();
		edu.mit.dig.saveflickr.model.Note.NoteImpl obj = (edu.mit.dig.saveflickr.model.Note.NoteImpl)objects.get(code);
		if (obj == null) {
			obj = edu.mit.dig.saveflickr.model.Note.NoteImpl.getNote(resource, model);
			if (obj == null)
				return null;
	...
	/**
	 * Return an instance of Note for every resource in the model with rdf:Type http://www.foolme.csail.mit.edu/ns/flickr/Note.owl#Note
	 * @param model the Jena Model
	...
	public static Thing getThing(com.hp.hpl.jena.rdf.model.Resource res, com.hp.hpl.jena.rdf.model.Model model) throws JastorException {
		if (res.hasProperty(RDF.type,model.getResource("http://www.foolme.csail.mit.edu/ns/flickr/Note.owl#Note"))) {
	...
	public static java.util.List listCompatibleInterfaces (com.hp.hpl.jena.rdf.model.Resource type) {
		...
		if (type.equals(edu.mit.dig.saveflickr.model.Note.Note.TYPE)) {
			types.add(edu.mit.dig.saveflickr.model.Note.Note.class);
		}
		return types;
	}
}