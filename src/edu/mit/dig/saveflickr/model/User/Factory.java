 ...
 * <p>(URI: http://sharonmyrtle.com/DIG/flick/user#)</p>
 * <br>
 * <br>
 * <br>
 */
public class Factory extends com.ibm.adtech.jastor.ThingFactory { 
	...
	public static User createUser(Resource resource, Model model) throws JastorException {
		return edu.mit.dig.saveflickr.model.User.UserImpl.createUser(resource,model);
	}
	...
	public static User createUser(String uri, Model model) throws JastorException {
		User obj = edu.mit.dig.saveflickr.model.User.UserImpl.createUser(model.createResource(uri), model);
		return obj;
	}
	...
	public static User getUser(Resource resource, Model model) throws JastorException {
		String code = (model.hashCode()*17 + edu.mit.dig.saveflickr.model.User.User.class.hashCode()) + resource.toString();
		edu.mit.dig.saveflickr.model.User.UserImpl obj = (edu.mit.dig.saveflickr.model.User.UserImpl)objects.get(code);
		if (obj == null) {
			obj = edu.mit.dig.saveflickr.model.User.UserImpl.getUser(resource, model);
			if (obj == null)
				return null;
	...
	/**
	 * Return an instance of User for every resource in the model with rdf:Type http://www.foolme.csail.mit.edu/ns/flickr/User.owl#User
	 * @param model the Jena Model
	...
	public static Thing getThing(com.hp.hpl.jena.rdf.model.Resource res, com.hp.hpl.jena.rdf.model.Model model) throws JastorException {
		if (res.hasProperty(RDF.type,model.getResource("http://www.foolme.csail.mit.edu/ns/flickr/User.owl#User"))) {
	...
	public static java.util.List listCompatibleInterfaces (com.hp.hpl.jena.rdf.model.Resource type) {
		...
		if (type.equals(edu.mit.dig.saveflickr.model.User.User.TYPE)) {
			types.add(edu.mit.dig.saveflickr.model.User.User.class);
		}
		return types;
	}
}