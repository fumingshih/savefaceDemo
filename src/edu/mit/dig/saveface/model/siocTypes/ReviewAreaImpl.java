...
/**
 * Implementation of {@link edu.mit.dig.saveface.model.siocTypes.ReviewArea}
 ...
 * <br>
 */
public class ReviewAreaImpl extends com.ibm.adtech.jastor.ThingImpl implements edu.mit.dig.saveface.model.siocTypes.ReviewArea {
	...
	ReviewAreaImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static ReviewAreaImpl getReviewArea(Resource resource, Model model) throws JastorException {
		return new ReviewAreaImpl(resource, model);
	}
	    
	static ReviewAreaImpl createReviewArea(Resource resource, Model model) throws JastorException { 
		ReviewAreaImpl impl = new ReviewAreaImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, ReviewArea.TYPE)))
			impl._model.add(impl._resource, RDF.type, ReviewArea.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, edu.mit.dig.saveface.model.siocTypes.ReviewArea.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initLast__item__date() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#last_item_date properties in ReviewArea model not a Literal", stmt.getObject());
	...
	private void initFeed() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#feed properties in ReviewArea model not a Resource", stmt.getObject());
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#part_of properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initAccount() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/account properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__subscriber() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_subscriber properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__parent() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_parent properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLink() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#link properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initReferences() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/references properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initParent__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#parent_of properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDate() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/date properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			date.add(literal);
		}
	}
	...
	private void initDepiction() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/depiction properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__function() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_function properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLast__reply__date() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#last_reply_date properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#name properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			name.add(literal);
		}
	}
	...
	private void initHas__owner() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_owner properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNum__replies() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_replies properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initSubject() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/subject properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNum__views() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_views properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#nonNegativeInteger");
			if (obj != null)
				num__views.add(obj);
	...
	private void initId() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#id properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			id.add(literal);
		}
	}
	...
	private void initGroup__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#group_of properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNum__authors() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_authors properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#nonNegativeInteger");
			if (obj != null)
	...
	private void initHas__creator() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_creator properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNote() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#note properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			note.add(literal);
		}
	}
	...
	private void initRelated__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#related_to properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initContainer__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#container_of properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLinks__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#links_to properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDescription() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/description properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initNum__items() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_items properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#nonNegativeInteger");
			if (obj != null)
				num__items.add(obj);
	...
	private void initHas__space() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_space properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLast__activity__date() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#last_activity_date properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initTopic() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#topic properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__part() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_part properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initScope__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#scope_of properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initTitle() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/title properties in ReviewArea model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			title.add(literal);
		}
	}
	...
	private void initHas__group() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_group properties in ReviewArea model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof ReviewAreaListener))
			throw new IllegalArgumentException("ThingListener must be instance of ReviewAreaListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((ReviewAreaListener)listener);
		}
	}
			...
			if (stmt.getPredicate().equals(last__item__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__item__date.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.last__item__dateAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.feedAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_feed);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.part__ofAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.accountAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_account);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__subscriber.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__subscriberAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__subscriber);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__parent.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__parentAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__parent);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.linkAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_link);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.referencesAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_references);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParent__of.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.parent__ofAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_parent__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.dateAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.depictionAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_depiction);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__functionAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.last__reply__dateAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.nameAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__ownerAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__replies.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.num__repliesAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.subjectAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__views.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.num__viewsAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.idAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForGroup__of.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.group__ofAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_group__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__authors.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.num__authorsAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__creatorAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.noteAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.related__toAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_related__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForContainer__of.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.container__ofAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_container__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.links__toAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.descriptionAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__itemsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__items.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.num__itemsAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__spaceAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.last__activity__dateAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.topicAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_topic);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__part.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__partAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__part);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.scope__ofAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.titleAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__group.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__groupAdded(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__group);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(last__item__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__item__date.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.last__item__dateRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(feedProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.feedRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_feed);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.part__ofRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(accountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.accountRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_account);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__subscriberProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__subscriber.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__subscriberRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__subscriber);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__parentProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__parent.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__parentRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__parent);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(linkProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.linkRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(referencesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.referencesRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(parent__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForParent__of.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.parent__ofRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_parent__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.dateRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.depictionRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__functionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__functionRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.last__reply__dateRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.nameRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ownerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__ownerRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.num__repliesRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(subjectProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.subjectRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.num__viewsRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.idRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(group__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForGroup__of.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.group__ofRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_group__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.num__authorsRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__creatorRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.noteRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(related__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.related__toRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(container__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForContainer__of.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.container__ofRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_container__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(links__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.links__toRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.descriptionRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(num__itemsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.num__itemsRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__spaceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__spaceRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.last__activity__dateRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(topicProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.topicRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__partProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__part.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__partRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__part);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(scope__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.scope__ofRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						ReviewAreaListener listener=(ReviewAreaListener)iter.next();
						listener.titleRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__groupProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__group.iterator();iter.hasNext();){
							ReviewAreaListener listener=(ReviewAreaListener)iter.next();
							listener.has__groupRemoved(edu.mit.dig.saveface.model.siocTypes.ReviewAreaImpl.this,_has__group);
						}
					}
				}
				return;
