...
/**
 * Implementation of {@link edu.mit.dig.saveface.model.siocTypes.MailMessage}
 ...
 * <br>
 */
public class MailMessageImpl extends com.ibm.adtech.jastor.ThingImpl implements edu.mit.dig.saveface.model.siocTypes.MailMessage {
	...
	MailMessageImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static MailMessageImpl getMailMessage(Resource resource, Model model) throws JastorException {
		return new MailMessageImpl(resource, model);
	}
	    
	static MailMessageImpl createMailMessage(Resource resource, Model model) throws JastorException { 
		MailMessageImpl impl = new MailMessageImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, MailMessage.TYPE)))
			impl._model.add(impl._resource, RDF.type, MailMessage.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, edu.mit.dig.saveface.model.siocTypes.MailMessage.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initFeed() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#feed properties in MailMessage model not a Resource", stmt.getObject());
	...
	private void initNext__version() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#next_version properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initReply__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#reply_of properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#part_of properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initAttachment() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#attachment properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initAccount() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/account properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initAbout() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#about properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLink() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#link properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initEmbeds__knowledge() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#embeds_knowledge properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initReferences() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/references properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__status() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/access#has_status properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDate() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/date properties in MailMessage model not a Literal", stmt.getObject());
	...
	private void initDepiction() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/depiction properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__function() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_function properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrevious__version() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#previous_version properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLast__reply__date() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#last_reply_date properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#name properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			name.add(literal);
		}
	}
	...
	private void initHas__owner() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_owner properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNum__replies() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_replies properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initSubject() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/subject properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNum__views() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_views properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#nonNegativeInteger");
			if (obj != null)
				num__views.add(obj);
	...
	private void initId() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#id properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			id.add(literal);
		}
	}
	...
	private void initGroup__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#group_of properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNum__authors() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#num_authors properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#nonNegativeInteger");
			if (obj != null)
	...
	private void initHas__creator() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_creator properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNote() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#note properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			note.add(literal);
		}
	}
	...
	private void initContent() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#content properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			content.add(literal);
		}
	}
	...
	private void initRelated__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#related_to properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__discussion() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_discussion properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNext__by__date() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#next_by_date properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initIp__address() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#ip_address properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initLinks__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#links_to properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initDescription() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/description properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initAddressed__to() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#addressed_to properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initPrevious__by__date() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#previous_by_date properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLatest__version() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#latest_version properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__modifier() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_modifier properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__space() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_space properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initLast__activity__date() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#last_activity_date properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initTopic() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#topic properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__part() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_part properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initScope__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#scope_of properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initTitle() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/title properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			title.add(literal);
		}
	}
	...
	private void initHas__container() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_container properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__group() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_group properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__reply() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_reply properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initNs1_Title() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#title properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initContent__encoded() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#content_encoded properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initModified__at() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#modified_at properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initNs1_Description() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#description properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initNs1_Subject() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#subject properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initReference() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#reference properties in MailMessage model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initCreated__at() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#created_at properties in MailMessage model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof MailMessageListener))
			throw new IllegalArgumentException("ThingListener must be instance of MailMessageListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((MailMessageListener)listener);
		}
	}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.feedAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_feed);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForNext__version.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.next__versionAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_next__version);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReply__of.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.reply__ofAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_reply__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.part__ofAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAttachment.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.attachmentAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_attachment);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.accountAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_account);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAbout.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.aboutAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_about);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.linkAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_link);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEmbeds__knowledge.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.embeds__knowledgeAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_embeds__knowledge);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.referencesAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_references);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__status.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__statusAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__status);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.dateAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.depictionAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_depiction);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__functionAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__function);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrevious__version.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.previous__versionAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_previous__version);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.last__reply__dateAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.nameAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__ownerAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__replies.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.num__repliesAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.subjectAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__views.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.num__viewsAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.idAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForGroup__of.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.group__ofAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_group__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__authors.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.num__authorsAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__creatorAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.noteAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(contentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForContent.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.contentAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.related__toAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_related__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__discussion.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__discussionAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__discussion);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForNext__by__date.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.next__by__dateAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_next__by__date);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(ip__addressProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIp__address.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.ip__addressAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.links__toAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.descriptionAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAddressed__to.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.addressed__toAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_addressed__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrevious__by__date.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.previous__by__dateAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_previous__by__date);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLatest__version.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.latest__versionAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_latest__version);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__modifier.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__modifierAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__modifier);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__spaceAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.last__activity__dateAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.topicAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_topic);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__part.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__partAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__part);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.scope__ofAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.titleAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__container.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__containerAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__container);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__group.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__groupAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__group);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__reply.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__replyAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__reply);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(ns1_titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNs1_Title.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.ns1_titleAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(content__encodedProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForContent__encoded.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.content__encodedAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(modified__atProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForModified__at.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.modified__atAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(ns1_descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNs1_Description.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.ns1_descriptionAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(ns1_subjectProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNs1_Subject.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.ns1_subjectAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReference.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.referenceAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_reference);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(created__atProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForCreated__at.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.created__atAdded(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(feedProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.feedRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_feed);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(next__versionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForNext__version.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.next__versionRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_next__version);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(reply__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReply__of.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.reply__ofRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_reply__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.part__ofRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(attachmentProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAttachment.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.attachmentRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_attachment);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(accountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.accountRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_account);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(aboutProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAbout.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.aboutRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_about);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(linkProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.linkRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(embeds__knowledgeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForEmbeds__knowledge.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.embeds__knowledgeRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_embeds__knowledge);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(referencesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.referencesRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__statusProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__status.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__statusRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__status);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.dateRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.depictionRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__functionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__functionRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(previous__versionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrevious__version.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.previous__versionRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_previous__version);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.last__reply__dateRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.nameRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ownerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__ownerRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.num__repliesRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(subjectProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.subjectRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.num__viewsRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.idRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(group__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForGroup__of.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.group__ofRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_group__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.num__authorsRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__creatorRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.noteRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(contentProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForContent.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.contentRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(related__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.related__toRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__discussionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__discussion.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__discussionRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__discussion);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(next__by__dateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForNext__by__date.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.next__by__dateRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_next__by__date);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(ip__addressProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIp__address.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.ip__addressRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(links__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.links__toRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.descriptionRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(addressed__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAddressed__to.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.addressed__toRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_addressed__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(previous__by__dateProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPrevious__by__date.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.previous__by__dateRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_previous__by__date);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(latest__versionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLatest__version.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.latest__versionRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_latest__version);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__modifierProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__modifier.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__modifierRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__modifier);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__spaceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__spaceRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.last__activity__dateRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(topicProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.topicRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__partProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__part.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__partRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__part);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(scope__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.scope__ofRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.titleRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__containerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__container.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__containerRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__container);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__groupProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__group.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__groupRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__group);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__replyProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__reply.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.has__replyRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_has__reply);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(ns1_titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNs1_Title.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.ns1_titleRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(content__encodedProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForContent__encoded.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.content__encodedRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(modified__atProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForModified__at.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.modified__atRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(ns1_descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNs1_Description.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.ns1_descriptionRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(ns1_subjectProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNs1_Subject.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.ns1_subjectRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(referenceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReference.iterator();iter.hasNext();){
							MailMessageListener listener=(MailMessageListener)iter.next();
							listener.referenceRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,_reference);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(created__atProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForCreated__at.iterator();iter.hasNext();){
						MailMessageListener listener=(MailMessageListener)iter.next();
						listener.created__atRemoved(edu.mit.dig.saveface.model.siocTypes.MailMessageImpl.this,literal);
					}
				}
				return;
			}
