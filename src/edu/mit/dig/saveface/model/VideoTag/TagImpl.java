...
/**
 * Implementation of {@link edu.mit.dig.saveface.model.VideoTag.Tag}
 * Use the edu.mit.dig.saveface.model.VideoTag.Factory to create instances of this class.
 * <p>(URI: http://foolme.csail.mit.edu/ns/saveface/TagVideo.owl#Tag)</p>
 * <br>
 */
public class TagImpl extends com.ibm.adtech.jastor.ThingImpl implements edu.mit.dig.saveface.model.VideoTag.Tag {
	

	private static com.hp.hpl.jena.rdf.model.Property nameProperty = ResourceFactory.createProperty("http://foolme.csail.mit.edu/ns/saveface/TagVideo.owl#name");
	private java.util.ArrayList name;
	private static com.hp.hpl.jena.rdf.model.Property createdTimeProperty = ResourceFactory.createProperty("http://foolme.csail.mit.edu/ns/saveface/TagVideo.owl#createdTime");
    ...
    private void setupModelListener() {
    	...
    	edu.mit.dig.saveface.model.VideoTag.Factory.registerThing(this);
    }
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, edu.mit.dig.saveface.model.VideoTag.Tag.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initName() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://foolme.csail.mit.edu/ns/saveface/TagVideo.owl#name properties in Tag model not a Literal", stmt.getObject());
	...
	private void initCreatedTime() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://foolme.csail.mit.edu/ns/saveface/TagVideo.owl#createdTime properties in Tag model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						...
						listener.nameAdded(edu.mit.dig.saveface.model.VideoTag.TagImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(createdTimeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForCreatedTime.iterator();iter.hasNext();){
						TagListener listener=(TagListener)iter.next();
						listener.createdTimeAdded(edu.mit.dig.saveface.model.VideoTag.TagImpl.this,(com.hp.hpl.jena.datatypes.xsd.XSDDateTime)obj);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TagListener listener=(TagListener)iter.next();
						listener.nameRemoved(edu.mit.dig.saveface.model.VideoTag.TagImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(createdTimeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						TagListener listener=(TagListener)iter.next();
						listener.createdTimeRemoved(edu.mit.dig.saveface.model.VideoTag.TagImpl.this,(com.hp.hpl.jena.datatypes.xsd.XSDDateTime)obj);
					}
				}
				return;
			}
