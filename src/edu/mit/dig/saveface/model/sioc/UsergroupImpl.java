...
/**
 * Implementation of {@link edu.mit.dig.saveface.model.sioc.Usergroup}
 * Use the edu.mit.dig.saveface.model.sioc.Factory to create instances of this class.
 * <p>(URI: http://rdfs.org/sioc/ns#Usergroup)</p>
 * <br>
 */
public class UsergroupImpl extends com.ibm.adtech.jastor.ThingImpl implements edu.mit.dig.saveface.model.sioc.Usergroup {
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, edu.mit.dig.saveface.model.sioc.Usergroup.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#part_of properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initAccount() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/account properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initUsergroup__of() throws JastorException {
		...
		while(it.hasNext()) {
			...
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				edu.mit.dig.saveface.model.sioc.Space usergroup__of = edu.mit.dig.saveface.model.sioc.Factory.getSpace(resource,_model);
	...
	public void addUsergroup__of(edu.mit.dig.saveface.model.sioc.Space usergroup__of) throws JastorException {
	...
	public edu.mit.dig.saveface.model.sioc.Space addUsergroup__of() throws JastorException {
		edu.mit.dig.saveface.model.sioc.Space usergroup__of = edu.mit.dig.saveface.model.sioc.Factory.createSpace(_model.createResource(),_model);
		if (this.usergroup__of == null)
			initUsergroup__of();
		this.usergroup__of.add(usergroup__of);
		_model.add(_model.createStatement(_resource,usergroup__ofProperty,usergroup__of.resource()));
	...
	public edu.mit.dig.saveface.model.sioc.Space addUsergroup__of(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		edu.mit.dig.saveface.model.sioc.Space usergroup__of = edu.mit.dig.saveface.model.sioc.Factory.getSpace(resource,_model);
		if (this.usergroup__of == null)
			initUsergroup__of();
		if (this.usergroup__of.contains(usergroup__of))
	...
	public void removeUsergroup__of(edu.mit.dig.saveface.model.sioc.Space usergroup__of) throws JastorException {
		if (this.usergroup__of == null)
			initUsergroup__of();
		if (!this.usergroup__of.contains(usergroup__of))
			return;
	...
	private void initGroup__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#group_of properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__part() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_part properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__member() throws JastorException {
		...
		while(it.hasNext()) {
			...
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				edu.mit.dig.saveface.model.sioc.UserAccount has__member = edu.mit.dig.saveface.model.sioc.Factory.getUserAccount(resource,_model);
	...
	public void addHas__member(edu.mit.dig.saveface.model.sioc.UserAccount has__member) throws JastorException {
	...
	public edu.mit.dig.saveface.model.sioc.UserAccount addHas__member() throws JastorException {
		edu.mit.dig.saveface.model.sioc.UserAccount has__member = edu.mit.dig.saveface.model.sioc.Factory.createUserAccount(_model.createResource(),_model);
		if (this.has__member == null)
			initHas__member();
		this.has__member.add(has__member);
		_model.add(_model.createStatement(_resource,has__memberProperty,has__member.resource()));
	...
	public edu.mit.dig.saveface.model.sioc.UserAccount addHas__member(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		edu.mit.dig.saveface.model.sioc.UserAccount has__member = edu.mit.dig.saveface.model.sioc.Factory.getUserAccount(resource,_model);
		if (this.has__member == null)
			initHas__member();
		if (this.has__member.contains(has__member))
	...
	public void removeHas__member(edu.mit.dig.saveface.model.sioc.UserAccount has__member) throws JastorException {
		if (this.has__member == null)
			initHas__member();
		if (!this.has__member.contains(has__member))
			return;
	...
	private void initHas__group() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_group properties in Usergroup model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							...
							listener.feedAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_feed);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.part__ofAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.accountAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_account);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.linkAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_link);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.referencesAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.dateAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.depictionAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_depiction);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__functionAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.last__reply__dateAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.nameAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__ownerAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__replies.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__repliesAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.subjectAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__views.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__viewsAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(usergroup__ofProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					edu.mit.dig.saveface.model.sioc.Space _usergroup__of = null;
					try {
						_usergroup__of = edu.mit.dig.saveface.model.sioc.Factory.getSpace(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (usergroup__of == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForUsergroup__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.usergroup__ofAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_usergroup__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.idAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForGroup__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.group__ofAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_group__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__authors.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__authorsAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__creatorAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.noteAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.related__toAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_related__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.links__toAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.descriptionAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__spaceAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.last__activity__dateAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.topicAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_topic);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__part.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__partAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__part);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__memberProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					edu.mit.dig.saveface.model.sioc.UserAccount _has__member = null;
					try {
						_has__member = edu.mit.dig.saveface.model.sioc.Factory.getUserAccount(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__member == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__member.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__memberAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__member);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.scope__ofAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.titleAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__group.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__groupAdded(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__group);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(feedProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.feedRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_feed);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.part__ofRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(accountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.accountRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_account);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(linkProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.linkRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(referencesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.referencesRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.dateRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.depictionRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__functionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__functionRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.last__reply__dateRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.nameRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ownerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__ownerRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__repliesRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(subjectProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.subjectRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__viewsRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (usergroup__of != null) {
						...
						for (int i=0;i<usergroup__of.size();i++) {
							edu.mit.dig.saveface.model.sioc.Space __item = (edu.mit.dig.saveface.model.sioc.Space) usergroup__of.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForUsergroup__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.usergroup__ofRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_usergroup__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.idRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(group__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForGroup__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.group__ofRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_group__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.num__authorsRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__creatorRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.noteRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(related__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.related__toRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(links__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.links__toRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.descriptionRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__spaceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__spaceRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.last__activity__dateRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(topicProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.topicRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__partProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__part.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__partRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__part);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__member != null) {
						...
						for (int i=0;i<has__member.size();i++) {
							edu.mit.dig.saveface.model.sioc.UserAccount __item = (edu.mit.dig.saveface.model.sioc.UserAccount) has__member.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__member = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__member.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__memberRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__member);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(scope__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.scope__ofRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						UsergroupListener listener=(UsergroupListener)iter.next();
						listener.titleRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__groupProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__group.iterator();iter.hasNext();){
							UsergroupListener listener=(UsergroupListener)iter.next();
							listener.has__groupRemoved(edu.mit.dig.saveface.model.sioc.UsergroupImpl.this,_has__group);
						}
					}
				}
				return;
