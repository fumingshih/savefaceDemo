...
public interface Role extends com.ibm.adtech.jastor.Thing {
	...
	/**
	 * The Jena Property for has__permission 
	 * <p>(URI: http://rdfs.org/sioc/access#has_permission)</p>
	 * <br>
	 * <br>
	 * RDF Schema Standard Properties <br>
	 * 	label : has permission@en <br>
	 * 	comment : A Permission assigned to a Role.@en <br>
	 * 	isDefinedBy : http://rdfs.org/sioc/access# <br>
	 * <br>  
	 */
	public static com.hp.hpl.jena.rdf.model.Property has__permissionProperty = ResourceFactory.createProperty("http://rdfs.org/sioc/access#has_permission");
	...
	/**
	 * Get an Iterator the 'has__permission' property values.  This Iteartor
	 * may be used to remove all such values.
	 * @return		{@link java.util.Iterator} of {@link edu.mit.dig.saveface.model.siocAccess.Permission}
	 * @see			#has__permissionProperty
	 */
	public java.util.Iterator getHas__permission() throws com.ibm.adtech.jastor.JastorException;

	/**
	 * Adds a value for the 'has__permission' property
	 * @param		The {@link edu.mit.dig.saveface.model.siocAccess.Permission} to add
	 * @see			#has__permissionProperty
	 */
	public void addHas__permission(edu.mit.dig.saveface.model.siocAccess.Permission has__permission) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Adds an anonymous value for the 'has__permission' property
	 * @return		The anoymous {@link edu.mit.dig.saveface.model.siocAccess.Permission} created
	 * @see			#has__permissionProperty
	 */
	public edu.mit.dig.saveface.model.siocAccess.Permission addHas__permission() throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * 
	 * The resource argument have rdf:type http://rdfs.org/sioc/access#Permission.  That is, this method
	 * should not be used as a shortcut for creating new objects in the model.
	 * @param		The {@link om.hp.hpl.jena.rdf.model.Resource} to add
	 * @see			#has__permissionProperty
	 */
	public edu.mit.dig.saveface.model.siocAccess.Permission addHas__permission(com.hp.hpl.jena.rdf.model.Resource resource) throws com.ibm.adtech.jastor.JastorException;
	
	/**
	 * Removes a value for the 'has__permission' property.  This method should not
	 * be invoked while iterator through values.  In that case, the remove() method of the Iterator
	 * itself should be used.
	 * @param		The {@link edu.mit.dig.saveface.model.siocAccess.Permission} to remove
	 * @see			#has__permissionProperty
	 */
	public void removeHas__permission(edu.mit.dig.saveface.model.siocAccess.Permission has__permission) throws com.ibm.adtech.jastor.JastorException;
