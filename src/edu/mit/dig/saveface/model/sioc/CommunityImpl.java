...
/**
 * Implementation of {@link edu.mit.dig.saveface.model.sioc.Community}
 * Use the edu.mit.dig.saveface.model.sioc.Factory to create instances of this class.
 * <p>(URI: http://rdfs.org/sioc/ns#Community)</p>
 * <br>
 */
public class CommunityImpl extends com.ibm.adtech.jastor.ThingImpl implements edu.mit.dig.saveface.model.sioc.Community {
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, edu.mit.dig.saveface.model.sioc.Community.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#part_of properties in Community model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initAccount() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/account properties in Community model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initGroup__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#group_of properties in Community model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__part() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_part properties in Community model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__group() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_group properties in Community model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							...
							listener.feedAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_feed);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.part__ofAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.accountAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_account);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.linkAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_link);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.referencesAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.dateAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.depictionAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_depiction);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__functionAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.last__reply__dateAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.nameAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__ownerAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__replies.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.num__repliesAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.subjectAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__views.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.num__viewsAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.idAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForGroup__of.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.group__ofAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_group__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__authors.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.num__authorsAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__creatorAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.noteAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.related__toAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_related__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.links__toAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.descriptionAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__spaceAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.last__activity__dateAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.topicAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_topic);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__part.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__partAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__part);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.scope__ofAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.titleAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__group.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__groupAdded(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__group);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(feedProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.feedRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_feed);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.part__ofRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(accountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.accountRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_account);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(linkProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.linkRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(referencesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.referencesRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.dateRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.depictionRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__functionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__functionRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.last__reply__dateRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.nameRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ownerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__ownerRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.num__repliesRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(subjectProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.subjectRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.num__viewsRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.idRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(group__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForGroup__of.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.group__ofRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_group__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.num__authorsRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__creatorRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.noteRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(related__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.related__toRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(links__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.links__toRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.descriptionRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__spaceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__spaceRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.last__activity__dateRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(topicProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.topicRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__partProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__part.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__partRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__part);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(scope__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.scope__ofRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						CommunityListener listener=(CommunityListener)iter.next();
						listener.titleRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__groupProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__group.iterator();iter.hasNext();){
							CommunityListener listener=(CommunityListener)iter.next();
							listener.has__groupRemoved(edu.mit.dig.saveface.model.sioc.CommunityImpl.this,_has__group);
						}
					}
				}
				return;
