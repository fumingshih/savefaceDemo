...
/**
 * Implementation of {@link edu.mit.dig.saveface.model.sioc.Role}
 * Use the edu.mit.dig.saveface.model.sioc.Factory to create instances of this class.
 * <p>(URI: http://rdfs.org/sioc/ns#Role)</p>
 * <br>
 */
public class RoleImpl extends com.ibm.adtech.jastor.ThingImpl implements edu.mit.dig.saveface.model.sioc.Role {
	...
	private static com.hp.hpl.jena.rdf.model.Property has__permissionProperty = ResourceFactory.createProperty("http://rdfs.org/sioc/access#has_permission");
	private java.util.ArrayList has__permission;
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,has__permissionProperty,(RDFNode)null);
		while (it.hasNext()) {
			list.add(it.next());
		}
		...
		it = _model.listStatements(_resource,RDF.type, edu.mit.dig.saveface.model.sioc.Role.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initPart__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#part_of properties in Role model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initAccount() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/account properties in Role model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__permission() throws JastorException {
		this.has__permission = new java.util.ArrayList();
		StmtIterator it = _model.listStatements(_resource, has__permissionProperty, (RDFNode)null);
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/access#has_permission properties in Role model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				edu.mit.dig.saveface.model.siocAccess.Permission has__permission = edu.mit.dig.saveface.model.siocAccess.Factory.getPermission(resource,_model);
				this.has__permission.add(has__permission);
			}
		}
	}

	public java.util.Iterator getHas__permission() throws JastorException {
		if (has__permission == null)
			initHas__permission();
		return new com.ibm.adtech.jastor.util.CachedPropertyIterator(has__permission,_resource,has__permissionProperty,true);
	}

	public void addHas__permission(edu.mit.dig.saveface.model.siocAccess.Permission has__permission) throws JastorException {
		if (this.has__permission == null)
			initHas__permission();
		if (this.has__permission.contains(has__permission)) {
			this.has__permission.remove(has__permission);
			this.has__permission.add(has__permission);
			return;
		}
		this.has__permission.add(has__permission);
		_model.add(_model.createStatement(_resource,has__permissionProperty,has__permission.resource()));
	}
	
	public edu.mit.dig.saveface.model.siocAccess.Permission addHas__permission() throws JastorException {
		edu.mit.dig.saveface.model.siocAccess.Permission has__permission = edu.mit.dig.saveface.model.siocAccess.Factory.createPermission(_model.createResource(),_model);
		if (this.has__permission == null)
			initHas__permission();
		this.has__permission.add(has__permission);
		_model.add(_model.createStatement(_resource,has__permissionProperty,has__permission.resource()));
		return has__permission;
	}
	
	public edu.mit.dig.saveface.model.siocAccess.Permission addHas__permission(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		edu.mit.dig.saveface.model.siocAccess.Permission has__permission = edu.mit.dig.saveface.model.siocAccess.Factory.getPermission(resource,_model);
		if (this.has__permission == null)
			initHas__permission();
		if (this.has__permission.contains(has__permission))
	...
	public void removeHas__permission(edu.mit.dig.saveface.model.siocAccess.Permission has__permission) throws JastorException {
		if (this.has__permission == null)
			initHas__permission();
		if (!this.has__permission.contains(has__permission))
			return;
		if (!_model.contains(_resource, has__permissionProperty, has__permission.resource()))
			return;
		this.has__permission.remove(has__permission);
		_model.removeAll(_resource, has__permissionProperty, has__permission.resource());
	}
	...
	private void initGroup__of() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#group_of properties in Role model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__part() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_part properties in Role model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHas__group() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://rdfs.org/sioc/ns#has_group properties in Role model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							...
							listener.feedAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_feed);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.part__ofAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_part__of);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.accountAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_account);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFunction__of.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.function__ofAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_function__of);
						}
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__permissionProperty)) {
				if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
					return;
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					edu.mit.dig.saveface.model.siocAccess.Permission _has__permission = null;
					try {
						_has__permission = edu.mit.dig.saveface.model.siocAccess.Factory.getPermission(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (has__permission == null) {
					...
					if (!has__permission.contains(_has__permission))
						has__permission.add(_has__permission);
					if (listeners != null) {
						java.util.ArrayList consumersForHas__permission;
						synchronized (listeners) {
							consumersForHas__permission = (java.util.ArrayList) listeners.clone();
						}
						for(java.util.Iterator iter=consumersForHas__permission.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__permissionAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__permission);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.linkAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_link);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.referencesAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.dateAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.depictionAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_depiction);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__functionAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__function);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__scope.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__scopeAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__scope);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.last__reply__dateAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.nameAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__ownerAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__replies.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.num__repliesAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.subjectAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__views.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.num__viewsAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.idAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForGroup__of.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.group__ofAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_group__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNum__authors.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.num__authorsAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__creatorAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.noteAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.related__toAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_related__to);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.links__toAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.descriptionAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__spaceAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.last__activity__dateAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.topicAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_topic);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__part.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__partAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__part);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.scope__ofAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.titleAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__group.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__groupAdded(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__group);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(feedProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFeed.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.feedRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_feed);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(part__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPart__of.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.part__ofRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_part__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(accountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.accountRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_account);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(function__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFunction__of.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.function__ofRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_function__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__permissionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (has__permission != null) {
						boolean found = false;
						for (int i=0;i<has__permission.size();i++) {
							edu.mit.dig.saveface.model.siocAccess.Permission __item = (edu.mit.dig.saveface.model.siocAccess.Permission) has__permission.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_has__permission = __item;
								break;
							}
						}
						if (found)
							has__permission.remove(_has__permission);
						else {
							try {
								_has__permission = edu.mit.dig.saveface.model.siocAccess.Factory.getPermission(resource,_model);
							} catch (JastorException e) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__permission.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__permissionRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__permission);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(linkProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLink.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.linkRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_link);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(referencesProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForReferences.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.referencesRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_references);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDate.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.dateRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.depictionRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__functionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__function.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__functionRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__function);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__scopeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__scope.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__scopeRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__scope);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__reply__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__reply__date.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.last__reply__dateRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.nameRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__ownerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__owner.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__ownerRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__owner);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__repliesProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.num__repliesRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(subjectProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForSubject.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.subjectRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_subject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__viewsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.num__viewsRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(idProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForId.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.idRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(group__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForGroup__of.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.group__ofRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_group__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(num__authorsProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.num__authorsRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__creator.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__creatorRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(noteProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForNote.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.noteRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(related__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForRelated__to.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.related__toRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_related__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(links__toProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLinks__to.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.links__toRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_links__to);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(descriptionProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDescription.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.descriptionRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__spaceProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__space.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__spaceRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__space);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(last__activity__dateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLast__activity__date.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.last__activity__dateRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(topicProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForTopic.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.topicRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_topic);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(has__partProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__part.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__partRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__part);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(scope__ofProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForScope__of.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.scope__ofRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_scope__of);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						RoleListener listener=(RoleListener)iter.next();
						listener.titleRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(has__groupProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHas__group.iterator();iter.hasNext();){
							RoleListener listener=(RoleListener)iter.next();
							listener.has__groupRemoved(edu.mit.dig.saveface.model.sioc.RoleImpl.this,_has__group);
						}
					}
				}
				return;
