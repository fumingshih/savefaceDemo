...
/**
 * Implementation of {@link edu.mit.dig.saveface.model.geo.SpatialThing}
 ...
 * <br>
 */
public class SpatialThingImpl extends com.ibm.adtech.jastor.ThingImpl implements edu.mit.dig.saveface.model.geo.SpatialThing {
	...
	private void initLat() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.w3.org/2003/01/geo/wgs84_pos#lat properties in SpatialThing model not a Literal", stmt.getObject());
	...
	private void initLocation() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.w3.org/2003/01/geo/wgs84_pos#location properties in SpatialThing model not a Resource", stmt.getObject());
	...
	private void initAlt() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.w3.org/2003/01/geo/wgs84_pos#alt properties in SpatialThing model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			alt.add(literal);
		}
	}
	...
	private void init_long() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.w3.org/2003/01/geo/wgs84_pos#long properties in SpatialThing model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			_long.add(literal);
		}
	}
	...
	private void initLat__long() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.w3.org/2003/01/geo/wgs84_pos#lat_long properties in SpatialThing model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
			...
			if (stmt.getPredicate().equals(latProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLat.iterator();iter.hasNext();){
						...
						listener.latAdded(edu.mit.dig.saveface.model.geo.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLocation.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.locationAdded(edu.mit.dig.saveface.model.geo.SpatialThingImpl.this,_location);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(altProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAlt.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.altAdded(edu.mit.dig.saveface.model.geo.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(_longProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersFor_long.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener._longAdded(edu.mit.dig.saveface.model.geo.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(lat__longProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLat__long.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.lat__longAdded(edu.mit.dig.saveface.model.geo.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(latProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLat.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.latRemoved(edu.mit.dig.saveface.model.geo.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(locationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLocation.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.locationRemoved(edu.mit.dig.saveface.model.geo.SpatialThingImpl.this,_location);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(altProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAlt.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.altRemoved(edu.mit.dig.saveface.model.geo.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(_longProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersFor_long.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener._longRemoved(edu.mit.dig.saveface.model.geo.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(lat__longProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForLat__long.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.lat__longRemoved(edu.mit.dig.saveface.model.geo.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
