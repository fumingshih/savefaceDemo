 ...
 * <p>(URI: http://www.foolme.csail.mit.edu/ns/saveface/link#)</p>
 * <br>
 * <br>
 * <br>
 */
public class Factory extends com.ibm.adtech.jastor.ThingFactory { 
	...
	public static Link createLink(Resource resource, Model model) throws JastorException {
		return edu.mit.dig.saveface.model.Link.LinkImpl.createLink(resource,model);
	}
	...
	public static Link createLink(String uri, Model model) throws JastorException {
		Link obj = edu.mit.dig.saveface.model.Link.LinkImpl.createLink(model.createResource(uri), model);
		return obj;
	}
	...
	public static Link getLink(Resource resource, Model model) throws JastorException {
		String code = (model.hashCode()*17 + edu.mit.dig.saveface.model.Link.Link.class.hashCode()) + resource.toString();
		edu.mit.dig.saveface.model.Link.LinkImpl obj = (edu.mit.dig.saveface.model.Link.LinkImpl)objects.get(code);
		if (obj == null) {
			obj = edu.mit.dig.saveface.model.Link.LinkImpl.getLink(resource, model);
			if (obj == null)
				return null;
	...
	/**
	 * Return an instance of Link for every resource in the model with rdf:Type http://foolme.csail.mit.edu/ns/saveface/Link.owl#Link
	 * @param model the Jena Model
	...
	public static Thing getThing(com.hp.hpl.jena.rdf.model.Resource res, com.hp.hpl.jena.rdf.model.Model model) throws JastorException {
		if (res.hasProperty(RDF.type,model.getResource("http://foolme.csail.mit.edu/ns/saveface/Link.owl#Link"))) {
	...
	public static java.util.List listCompatibleInterfaces (com.hp.hpl.jena.rdf.model.Resource type) {
		...
		if (type.equals(edu.mit.dig.saveface.model.Link.Link.TYPE)) {
			types.add(edu.mit.dig.saveface.model.Link.Link.class);
		}
		return types;
	}
}