 ...
 * <p>(URI: http://www.foolme.csail.mit.edu/ns/saveface/tag#)</p>
 * <br>
 * <br>
 * <br>
 */
public class Factory extends com.ibm.adtech.jastor.ThingFactory { 
	...
	public static Tag createTag(Resource resource, Model model) throws JastorException {
		return edu.mit.dig.saveface.model.Tag.TagImpl.createTag(resource,model);
	}
	...
	public static Tag createTag(String uri, Model model) throws JastorException {
		Tag obj = edu.mit.dig.saveface.model.Tag.TagImpl.createTag(model.createResource(uri), model);
		return obj;
	}
	...
	public static Tag getTag(Resource resource, Model model) throws JastorException {
		String code = (model.hashCode()*17 + edu.mit.dig.saveface.model.Tag.Tag.class.hashCode()) + resource.toString();
		edu.mit.dig.saveface.model.Tag.TagImpl obj = (edu.mit.dig.saveface.model.Tag.TagImpl)objects.get(code);
		if (obj == null) {
			obj = edu.mit.dig.saveface.model.Tag.TagImpl.getTag(resource, model);
			if (obj == null)
				return null;
	...
	/**
	 * Return an instance of Tag for every resource in the model with rdf:Type http://www.foolme.csail.mit.edu/ns/saveface/Tag.owl#Tag
	 * @param model the Jena Model
	...
	public static Thing getThing(com.hp.hpl.jena.rdf.model.Resource res, com.hp.hpl.jena.rdf.model.Model model) throws JastorException {
		if (res.hasProperty(RDF.type,model.getResource("http://www.foolme.csail.mit.edu/ns/saveface/Tag.owl#Tag"))) {
	...
	public static java.util.List listCompatibleInterfaces (com.hp.hpl.jena.rdf.model.Resource type) {
		...
		if (type.equals(edu.mit.dig.saveface.model.Tag.Tag.TYPE)) {
			types.add(edu.mit.dig.saveface.model.Tag.Tag.class);
		}
		return types;
	}
}