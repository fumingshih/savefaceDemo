 ...
 * <p>(URI: http://www.foolme.csail.mit.edu/ns/saveface/comment#)</p>
 * <br>
 * <br>
 * <br>
 */
public class Factory extends com.ibm.adtech.jastor.ThingFactory { 
	...
	public static Comment createComment(Resource resource, Model model) throws JastorException {
		return edu.mit.dig.saveface.model.Comment.CommentImpl.createComment(resource,model);
	}
	...
	public static Comment createComment(String uri, Model model) throws JastorException {
		Comment obj = edu.mit.dig.saveface.model.Comment.CommentImpl.createComment(model.createResource(uri), model);
		return obj;
	}
	...
	public static Comment getComment(Resource resource, Model model) throws JastorException {
		String code = (model.hashCode()*17 + edu.mit.dig.saveface.model.Comment.Comment.class.hashCode()) + resource.toString();
		edu.mit.dig.saveface.model.Comment.CommentImpl obj = (edu.mit.dig.saveface.model.Comment.CommentImpl)objects.get(code);
		if (obj == null) {
			obj = edu.mit.dig.saveface.model.Comment.CommentImpl.getComment(resource, model);
			if (obj == null)
				return null;
	...
	/**
	 * Return an instance of Comment for every resource in the model with rdf:Type http://foolme.csail.mit.edu/ns/saveface/Comment.owl#Comment
	 * @param model the Jena Model
	...
	public static Thing getThing(com.hp.hpl.jena.rdf.model.Resource res, com.hp.hpl.jena.rdf.model.Model model) throws JastorException {
		if (res.hasProperty(RDF.type,model.getResource("http://foolme.csail.mit.edu/ns/saveface/Comment.owl#Comment"))) {
	...
	public static java.util.List listCompatibleInterfaces (com.hp.hpl.jena.rdf.model.Resource type) {
		...
		if (type.equals(edu.mit.dig.saveface.model.Comment.Comment.TYPE)) {
			types.add(edu.mit.dig.saveface.model.Comment.Comment.class);
		}
		return types;
	}
}