...
/**
 * Implementation of {@link edu.mit.dig.saveface.model.foaf.Group}
 * Use the edu.mit.dig.saveface.model.foaf.Factory to create instances of this class.
 * <p>(URI: http://xmlns.com/foaf/0.1/Group)</p>
 * <br>
 */
public class GroupImpl extends com.ibm.adtech.jastor.ThingImpl implements edu.mit.dig.saveface.model.foaf.Group {
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, edu.mit.dig.saveface.model.foaf.Group.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initCreator() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/creator properties in Group model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public com.hp.hpl.jena.rdf.model.Literal getAge() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": age getProperty() in edu.mit.dig.saveface.model.foaf.Group model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		age = literal;
		return literal;
	}
	...
	public com.hp.hpl.jena.rdf.model.Literal getBirthday() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": birthday getProperty() in edu.mit.dig.saveface.model.foaf.Group model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		birthday = literal;
		return literal;
	}
	...
	private void initDepiction() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/depiction properties in Group model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public com.hp.hpl.jena.rdf.model.Literal getGender() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": gender getProperty() in edu.mit.dig.saveface.model.foaf.Group model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		gender = literal;
		return literal;
	}
	...
	private void initLabel() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#label properties in Group model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initMember() throws JastorException {
		...
		while(it.hasNext()) {
			...
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
				edu.mit.dig.saveface.model.foaf.Agent member = edu.mit.dig.saveface.model.foaf.Factory.getAgent(resource,_model);
	...
	public void addMember(edu.mit.dig.saveface.model.foaf.Agent member) throws JastorException {
		if (this.member == null)
			initMember();
	...
	public edu.mit.dig.saveface.model.foaf.Agent addMember() throws JastorException {
		edu.mit.dig.saveface.model.foaf.Agent member = edu.mit.dig.saveface.model.foaf.Factory.createAgent(_model.createResource(),_model);
		if (this.member == null)
			initMember();
		this.member.add(member);
		_model.add(_model.createStatement(_resource,memberProperty,member.resource()));
	...
	public edu.mit.dig.saveface.model.foaf.Agent addMember(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		edu.mit.dig.saveface.model.foaf.Agent member = edu.mit.dig.saveface.model.foaf.Factory.getAgent(resource,_model);
		if (this.member == null)
			initMember();
		if (this.member.contains(member))
	...
	public void removeMember(edu.mit.dig.saveface.model.foaf.Agent member) throws JastorException {
		if (this.member == null)
			initMember();
		if (!this.member.contains(member))
			return;
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(statusProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForStatus.iterator();iter.hasNext();){
						...
						listener.statusAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(icqChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIcqChatID.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.icqChatIDAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.fundedByAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.dnaChecksumAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.titleAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.phoneAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_phone);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.makerAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mbox__sha1sumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMbox__sha1sum.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.mbox__sha1sumAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(msnChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMsnChatID.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.msnChatIDAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMbox.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.mboxAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_mbox);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForCreator.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.creatorAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_creator);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.accountAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_account);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(ageProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.ageChanged(edu.mit.dig.saveface.model.foaf.GroupImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(birthdayProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.birthdayChanged(edu.mit.dig.saveface.model.foaf.GroupImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(aimChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAimChatID.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.aimChatIDAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(givenNameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenName.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.givenNameAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.depictionAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(jabberIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForJabberID.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.jabberIDAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.pageAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(skypeIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSkypeID.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.skypeIDAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(genderProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.genderChanged(edu.mit.dig.saveface.model.foaf.GroupImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMade.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.madeAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_made);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForWeblog.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.weblogAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_weblog);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHoldsAccount.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.holdsAccountAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_holdsAccount);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.nameAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLabel.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.labelAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_label);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(memberProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					edu.mit.dig.saveface.model.foaf.Agent _member = null;
					try {
						_member = edu.mit.dig.saveface.model.foaf.Factory.getAgent(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (member == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMember.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.memberAdded(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_member);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(statusProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForStatus.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.statusRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(icqChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIcqChatID.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.icqChatIDRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(fundedByProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.fundedByRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.dnaChecksumRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.titleRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(phoneProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.phoneRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_phone);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(makerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.makerRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mbox__sha1sumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMbox__sha1sum.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.mbox__sha1sumRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(msnChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMsnChatID.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.msnChatIDRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(mboxProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMbox.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.mboxRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_mbox);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForCreator.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.creatorRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(accountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.accountRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_account);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(aimChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAimChatID.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.aimChatIDRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(givenNameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenName.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.givenNameRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.depictionRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(jabberIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForJabberID.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.jabberIDRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(pageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.pageRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(skypeIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSkypeID.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.skypeIDRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(madeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMade.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.madeRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_made);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(weblogProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForWeblog.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.weblogRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_weblog);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(holdsAccountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHoldsAccount.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.holdsAccountRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_holdsAccount);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						GroupListener listener=(GroupListener)iter.next();
						listener.nameRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(labelProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLabel.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.labelRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_label);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (member != null) {
						...
						for (int i=0;i<member.size();i++) {
							edu.mit.dig.saveface.model.foaf.Agent __item = (edu.mit.dig.saveface.model.foaf.Agent) member.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_member = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMember.iterator();iter.hasNext();){
							GroupListener listener=(GroupListener)iter.next();
							listener.memberRemoved(edu.mit.dig.saveface.model.foaf.GroupImpl.this,_member);
						}
					}
				}
				return;
