...
/**
 * Implementation of {@link edu.mit.dig.saveface.model.foaf.SpatialThing}
 ...
 * <br>
 */
public class SpatialThingImpl extends com.ibm.adtech.jastor.ThingImpl implements edu.mit.dig.saveface.model.foaf.SpatialThing {
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, edu.mit.dig.saveface.model.foaf.SpatialThing.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
		return list;
	...
	private void initIcqChatID() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/icqChatID properties in SpatialThing model not a Literal", stmt.getObject());
	...
	private void initMbox__sha1sum() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/mbox_sha1sum properties in SpatialThing model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initMsnChatID() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/msnChatID properties in SpatialThing model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initCreator() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/creator properties in SpatialThing model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initAimChatID() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/aimChatID properties in SpatialThing model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public void addBased__near(edu.mit.dig.saveface.model.foaf.SpatialThing based__near) throws JastorException {
	...
	public edu.mit.dig.saveface.model.foaf.SpatialThing addBased__near() throws JastorException {
		edu.mit.dig.saveface.model.foaf.SpatialThing based__near = edu.mit.dig.saveface.model.foaf.Factory.createSpatialThing(_model.createResource(),_model);
		if (this.based__near == null)
			initBased__near();
		this.based__near.add(based__near);
		_model.add(_model.createStatement(_resource,based__nearProperty,based__near.resource()));
	...
	public edu.mit.dig.saveface.model.foaf.SpatialThing addBased__near(com.hp.hpl.jena.rdf.model.Resource resource) throws JastorException {
		edu.mit.dig.saveface.model.foaf.SpatialThing based__near = edu.mit.dig.saveface.model.foaf.Factory.getSpatialThing(resource,_model);
		if (this.based__near == null)
			initBased__near();
		if (this.based__near.contains(based__near))
	...
	public void removeBased__near(edu.mit.dig.saveface.model.foaf.SpatialThing based__near) throws JastorException {
		if (this.based__near == null)
			initBased__near();
		if (!this.based__near.contains(based__near))
			return;
	...
	private void initDepiction() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/depiction properties in SpatialThing model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initJabberID() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/jabberID properties in SpatialThing model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initLabel() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#label properties in SpatialThing model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public void unregisterListener(ThingListener listener) {
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(icqChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIcqChatID.iterator();iter.hasNext();){
						...
						listener.icqChatIDAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.fundedByAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.dnaChecksumAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.titleAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.phoneAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_phone);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.makerAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mbox__sha1sumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMbox__sha1sum.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.mbox__sha1sumAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(msnChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMsnChatID.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.msnChatIDAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForCreator.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.creatorAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(aimChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAimChatID.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.aimChatIDAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(givenNameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenName.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.givenNameAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(based__nearProperty)) {
				...
				com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
				if (true) { // don't check resource type if the property range is Resource
					edu.mit.dig.saveface.model.foaf.SpatialThing _based__near = null;
					try {
						_based__near = edu.mit.dig.saveface.model.foaf.Factory.getSpatialThing(resource,_model);
					} catch (JastorException e) {
						//e.printStackTrace();
					}
					if (based__near == null) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBased__near.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.based__nearAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_based__near);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.depictionAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(jabberIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForJabberID.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.jabberIDAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.pageAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.nameAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLabel.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.labelAdded(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_label);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(icqChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIcqChatID.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.icqChatIDRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(fundedByProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.fundedByRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.dnaChecksumRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.titleRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(phoneProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.phoneRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_phone);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(makerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.makerRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mbox__sha1sumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMbox__sha1sum.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.mbox__sha1sumRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(msnChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMsnChatID.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.msnChatIDRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForCreator.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.creatorRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(aimChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAimChatID.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.aimChatIDRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(givenNameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenName.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.givenNameRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (based__near != null) {
						...
						for (int i=0;i<based__near.size();i++) {
							edu.mit.dig.saveface.model.foaf.SpatialThing __item = (edu.mit.dig.saveface.model.foaf.SpatialThing) based__near.get(i);
							if (__item.resource().equals(resource)) {
								found = true;
								_based__near = __item;
								break;
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForBased__near.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.based__nearRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_based__near);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.depictionRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(jabberIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForJabberID.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.jabberIDRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(pageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.pageRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						SpatialThingListener listener=(SpatialThingListener)iter.next();
						listener.nameRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(labelProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLabel.iterator();iter.hasNext();){
							SpatialThingListener listener=(SpatialThingListener)iter.next();
							listener.labelRemoved(edu.mit.dig.saveface.model.foaf.SpatialThingImpl.this,_label);
						}
					}
				}
				return;
