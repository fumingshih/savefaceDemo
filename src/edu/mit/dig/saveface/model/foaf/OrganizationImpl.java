...
/**
 * Implementation of {@link edu.mit.dig.saveface.model.foaf.Organization}
 ...
 * <br>
 */
public class OrganizationImpl extends com.ibm.adtech.jastor.ThingImpl implements edu.mit.dig.saveface.model.foaf.Organization {
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, edu.mit.dig.saveface.model.foaf.Organization.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initCreator() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://purl.org/dc/terms/creator properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public com.hp.hpl.jena.rdf.model.Literal getAge() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": age getProperty() in edu.mit.dig.saveface.model.foaf.Organization model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		age = literal;
		return literal;
	}
	...
	public com.hp.hpl.jena.rdf.model.Literal getBirthday() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": birthday getProperty() in edu.mit.dig.saveface.model.foaf.Organization model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		birthday = literal;
		return literal;
	}
	...
	private void initDepiction() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/depiction properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public com.hp.hpl.jena.rdf.model.Literal getGender() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": gender getProperty() in edu.mit.dig.saveface.model.foaf.Organization model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		gender = literal;
		return literal;
	}
	...
	private void initLabel() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#label properties in Organization model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(statusProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForStatus.iterator();iter.hasNext();){
						...
						listener.statusAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(icqChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIcqChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.icqChatIDAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.fundedByAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.dnaChecksumAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.titleAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.phoneAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_phone);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.makerAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mbox__sha1sumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMbox__sha1sum.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.mbox__sha1sumAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(msnChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMsnChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.msnChatIDAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMbox.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.mboxAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_mbox);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForCreator.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.creatorAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_creator);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.accountAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_account);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(ageProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.ageChanged(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(birthdayProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.birthdayChanged(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(aimChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAimChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.aimChatIDAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(givenNameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenName.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.givenNameAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.depictionAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(jabberIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForJabberID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.jabberIDAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.pageAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(skypeIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSkypeID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.skypeIDAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(genderProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.genderChanged(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMade.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.madeAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_made);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForWeblog.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.weblogAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_weblog);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHoldsAccount.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.holdsAccountAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_holdsAccount);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.nameAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLabel.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.labelAdded(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_label);
						}
					}
				}
				return;
...
//				return;
			if (stmt.getPredicate().equals(statusProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForStatus.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.statusRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(icqChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForIcqChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.icqChatIDRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(fundedByProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForFundedBy.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.fundedByRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_fundedBy);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(dnaChecksumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForDnaChecksum.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.dnaChecksumRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(titleProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForTitle.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.titleRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(phoneProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPhone.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.phoneRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_phone);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(makerProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMaker.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.makerRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_maker);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(mbox__sha1sumProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMbox__sha1sum.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.mbox__sha1sumRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(msnChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForMsnChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.msnChatIDRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(mboxProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMbox.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.mboxRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_mbox);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(creatorProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForCreator.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.creatorRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_creator);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(accountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForAccount.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.accountRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_account);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(aimChatIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForAimChatID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.aimChatIDRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(givenNameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForGivenName.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.givenNameRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(depictionProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForDepiction.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.depictionRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_depiction);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(jabberIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForJabberID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.jabberIDRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(pageProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForPage.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.pageRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_page);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(skypeIDProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForSkypeID.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.skypeIDRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(madeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForMade.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.madeRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_made);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(weblogProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForWeblog.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.weblogRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_weblog);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(holdsAccountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHoldsAccount.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.holdsAccountRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_holdsAccount);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(nameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForName.iterator();iter.hasNext();){
						OrganizationListener listener=(OrganizationListener)iter.next();
						listener.nameRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(labelProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForLabel.iterator();iter.hasNext();){
							OrganizationListener listener=(OrganizationListener)iter.next();
							listener.labelRemoved(edu.mit.dig.saveface.model.foaf.OrganizationImpl.this,_label);
						}
					}
				}
				return;
